...
var masterChannel = ''; // match with masterChannel var in backend file
var masterPushinPubAddress = '';
...
wsServer.on("request", function(request) {
  ...
  connection.on("message", function(message) {
    ...
    var pub = new grip.GripPubControl({
      'control_uri': masterPushinPubAddress,
    });

    pub.publishHttpStream(masterChannel, message.binaryData);
  });
